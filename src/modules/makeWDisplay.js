...
const elmnts = () => {
    ...
    let container1 = div("flex justify-around items-center my-4")
    let image = img()
    ...
    let container3 = div("flex justify-around pl-20 my-8")
    let wind = div("text-5xl", 'wind')
    let random = div("text-3xl")
    random.innerHTML = ' | '
    let humidity = div("text-5xl", 'humidity')
    container3.append(wind, random, humidity)
